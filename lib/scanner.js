...
// wrappers as typed skills. The scanner records every carrier and never
// consults this set; classification happens at aggregation time in the
// renderer, where a name is a builtin if it ever arrived as a local_command
// line OR sits here. Builtins migrate between line shapes across Claude
// Code versions (/model has shipped both ways), so the set covers names
// regardless of delivery shape, and keeping it out of the scanner means it
// can grow without invalidating cached meta. Unobserved names are harmless.
